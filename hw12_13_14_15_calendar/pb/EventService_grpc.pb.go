...
type EventServiceClient interface {
	Add(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	Update(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	Delete(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	List(ctx context.Context, in *ListEvents, opts ...grpc.CallOption) (*EventsResponse, error)
}
...
func (c *eventServiceClient) Add(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
...
func (c *eventServiceClient) Update(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
func (c *eventServiceClient) Delete(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
func (c *eventServiceClient) List(ctx context.Context, in *ListEvents, opts ...grpc.CallOption) (*EventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type EventServiceServer interface {
	Add(context.Context, *EventRequest) (*EmptyResponse, error)
	Update(context.Context, *EventRequest) (*EmptyResponse, error)
	Delete(context.Context, *EventRequest) (*EmptyResponse, error)
	List(context.Context, *ListEvents) (*EventsResponse, error)
...
func (UnimplementedEventServiceServer) Add(context.Context, *EventRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedEventServiceServer) Update(context.Context, *EventRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedEventServiceServer) Delete(context.Context, *EventRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedEventServiceServer) List(context.Context, *ListEvents) (*EventsResponse, error) {
...
func _EventService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).Delete(ctx, req.(*EventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EventService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).List(ctx, req.(*ListEvents))
	}
	return interceptor(ctx, in, info, handler)
}
